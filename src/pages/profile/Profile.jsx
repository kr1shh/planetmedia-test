...
const Profile = () => {
  const { values, handleChange, isSubmitting, resetForm, setSubmitting } =
    useForm({
      firstName: "",
      lastName: "",
      email: "",
  ...
  return (
    <>
      <form
        ...
        className="w-full h-full gap-6 flex items-center justify-center bg-white flex-col py-16 rounded-2xl"
      >
        ...
        <div className="flex flex-col gap-2 w-[70%]">
          <label htmlFor="location" className="text-base text-gray-600">
