      ...
      <nav className="flex justify-between items-center py-4 px-4 bg-white drop-shadow-xl">
        <div className="container mx-auto flex items-center justify-between">
          ...
          <div className="flex gap-3">
            <button
              className="border border-gray-200 rounded-[50px] px-6 py-2 cursor-pointer"
              onClick={() => navigate("/login")}
            >
              {userName ? `${userName}` : "Login"}
            </button>
            <button
              className="border border-accent bg-accent text-white rounded-[50px] px-6 py-2 cursor-pointer"
